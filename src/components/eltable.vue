...
<div>
  ...
  <el-table
    ...
    <el-table-column
      label="添加到自选股">
      <template scope="scope">
        <el-button @click="handleAdd(scope.row)" type="text">添加到自选股</el-button>
      </template>
    </el-table-column>
  </el-table>
  <div class="block">
  ...
  export default {
    ...
    methods: {
      handleAdd (row) {
        ...
        xmlhttp.open('GET', 'http://127.0.0.1:1000/zi?code=' + row.code, true)
        xmlhttp.send()
      },
      load: function (pageNum) {
        ...
        xmlhttp.open('GET', 'http://127.0.0.1:1000/load', true)
        xmlhttp.send()
      },
